object Versions {
    ...
    const val androidx_lifecycleLibVersion = "2.9.0"
    const val androidx_pagingLibVersion = "2.1.1"
    const val androidx_navigationLibVersion = "2.9.7"
    ...
    // Dagger Dependencies.
    const val daggerLibVersion = "2.57.2"
    ...
    const val rxjava2AdapterLibVersion = "2.11.0"
    const val rxjava3AdapterLibVersion = "3.0.0-RC8"

    // Square Dependencies.
    const val retrofit2LibVersion = "2.11.0"
    const val okhttp3LibVersion = "4.8.0"

    // Moshi
    const val moshiLibVersion = "1.15.2"
    const val converterMoshiLibVersion = "2.11.0"

    // Image cache
    const val glideLibVersion = "4.11.0"

    // Image cache
    const val paperdbLibVersion = "2.7.2"
