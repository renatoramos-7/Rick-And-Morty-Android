...
import com.renatoramos.rickandmorty.characters.R as CharactersR
import com.renatoramos.rickandmorty.episodes.R as EpisodesR
import com.renatoramos.rickandmorty.home.R
import com.renatoramos.rickandmorty.home.databinding.ActivityMainBinding
...
class HomeAppActivity : BaseActivity() {
    ...
    private val appBarConfiguration: AppBarConfiguration by lazy {
        AppBarConfiguration.Builder(
            setOf(
                CharactersR.id.characters_list_fragment,
                EpisodesR.id.episodes_list_fragment
            )
        ).build()
    }
